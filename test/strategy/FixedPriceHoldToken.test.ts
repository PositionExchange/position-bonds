...
import {
    ...
    now,
    expectERC20Balance,
    expectBalanceOfToken, expectMultiERC20Balance, ExpectErc20Detail, setDataForExpectedMap, approveAndMintToken
} from "../utils/utils";
...
describe("Fixed Price HoldToken", async () => {
    ...
    describe(" purchase ", async ()=> {
        // TODO check hold token
        // TODO check get bon amount correct with fixed price
    ...
    describe("claim underlying asset", async  ()=>{
